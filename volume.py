...
class NiftyChartApp:
    ...
    def setup_supabase(self):
        ...
        try:
            # Check if we have all required Supabase secrets
            if not self.supabase_url or not self.supabase_key:
                st.warning("Supabase credentials not found. App will run without database functionality.")
                self.supabase = None
                return
