...
def calculate_market_phase(option_chain, spot_price, price_change):
    """
    Calculate market phase based on option chain data and price movement.
    Returns: (phase_name, score, interpretation)
    """
    score = 0
